...
#endif
{
    ...
    // インターフェース取得
    convInterface = AE2ZeroLatencyFFTConvolve_GetInterface();
...
//==============================================================================
const juce::String AE2AudioProcessor::getName() const
{
...
int AE2AudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int AE2AudioProcessor::getCurrentProgram()
{
    return 0;
}

void AE2AudioProcessor::setCurrentProgram (int index)
{
    ignoreUnused (index);
}

const juce::String AE2AudioProcessor::getProgramName (int index)
{
    ignoreUnused (index);
    return {};
}

void AE2AudioProcessor::changeProgramName (int index, const juce::String& newName)
{
    ignoreUnused (index);
...
//==============================================================================
void AE2AudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void AE2AudioProcessor::releaseResources()
{
}
...
void AE2AudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
//==============================================================================
bool AE2AudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor* AE2AudioProcessor::createEditor()
{
    return new AE2AudioProcessorEditor (*this);
}

//==============================================================================
void AE2AudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
    ignoreUnused (destData);
}

void AE2AudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
    ignoreUnused (data);
...
// インパルスの設定
void AE2AudioProcessor::setImpulse (const float* const* impulse, uint32_t channelCounts, uint32_t impulseLength)
{
    convLock.enter();
